...
``pb2/`` is generated from the .proto files in ``protobufs/`` via::
    ...
    python -m grpc_tools.protoc -I protobufs --python_out=steam_api/pb2 \\
        ...
        protobufs/steammessages_econ.steamclient.proto
...
from steammessages_econ.steamclient_pb2 import (  # noqa: E402
    CEcon_Asset,
